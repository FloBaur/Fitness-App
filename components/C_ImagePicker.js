    ...
    return (
        <View style={styles.imagePicker}>
            <View style={styles.imagePreview}>
                {!pickedImage && !defaultImage ? <Text>No image picked yet</Text>: image}
            </View>
            <View style={styles.buttonContainer}>
                <View style={styles.button}>
                    <Button title="Take Image" color={CONST_Colors.primary}
                            onPress={takeImageHandler}
                    />
                </View>
                <View style={styles.button}>
                    <Button title="No Image" color={CONST_Colors.accent}
